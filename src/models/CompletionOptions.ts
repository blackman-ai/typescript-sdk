...
/**
 * Check if a given object implements the CompletionOptions interface.
 */
export function instanceOfCompletionOptions(value: object): value is CompletionOptions {
    return true;
}

export function CompletionOptionsFromJSON(json: any): CompletionOptions {
    return CompletionOptionsFromJSONTyped(json, false);
}

export function CompletionOptionsFromJSONTyped(json: any, ignoreDiscriminator: boolean): CompletionOptions {
    if (json == null) {
        return json;
    }
    return {
...
export function CompletionOptionsToJSON(json: any): CompletionOptions {
    return CompletionOptionsToJSONTyped(json, false);
}

export function CompletionOptionsToJSONTyped(value?: CompletionOptions | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
