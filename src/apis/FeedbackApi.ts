...
export class FeedbackApi extends runtime.BaseAPI {
     ...
     */
    async submitFeedbackRaw(requestParameters: SubmitFeedbackOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<SubmitFeedbackResponse>> {
     ...
     * Submit feedback for a completion response
     */
    async submitFeedback(requestParameters: SubmitFeedbackOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SubmitFeedbackResponse> {
